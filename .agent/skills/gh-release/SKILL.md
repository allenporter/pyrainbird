...
1. Stage the `pyproject.toml` file.
1. Commit the change with the message `chore(release): 0.9.1`.
1. Push the changes to the `main` branch.
1. Create a GitHub release named `0.9.1` with auto-generated release notes using `gh release create "0.9.1" --generate-notes`.
